...
type Args struct {
	Entity string         `json:"entity" jsonschema:"inbox"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.RepoManagerSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "repo_manager_list",
		Description: "List records from RepoManager. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "repo_manager_load",
		Description: "Load a single record from RepoManager. " +
...
func runOp(client *sdk.RepoManagerSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.RepoManagerSDK, name string) (sdk.RepoManagerEntity, error) {
