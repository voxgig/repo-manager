...
func NewRepoManagerSDK(options map[string]any) *RepoManagerSDK {
	sdk := &RepoManagerSDK{
		Mode:     "live",
		Features: []Feature{},
	}
...
func (sdk *RepoManagerSDK) OptionsMap() map[string]any {
...
func (sdk *RepoManagerSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *RepoManagerSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *RepoManagerSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RepoManagerSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *RepoManagerSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *RepoManagerSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath(sdk.options, []any{"allow", "op"}).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("RepoManagerSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *RepoManagerSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *RepoManagerSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("RepoManagerSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *RepoManagerSDK) Inbox(data map[string]any) RepoManagerEntity {
	return NewInboxEntityFunc(sdk, data)
}



func TestSDK(testopts map[string]any, sdkopts map[string]any) *RepoManagerSDK {
	if sdkopts == nil {
