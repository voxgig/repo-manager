# RepoManager Golang SDK Reference

Complete API reference for the RepoManager Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *RepoManagerSDK`
...
#### `Inbox(data map[string]any) RepoManagerEntity`
